...
Before verifying property (2), we prove \eqref{equation:kt-potential-beta}. We
...
Let $\phi(g) = \frac{F_t(x+g)}{F_{t-1}(x)}$. To very property (2) of the definition,
it suffices to show that $\phi(g) \le 1 + g \frac{x}{t+\delta}$
