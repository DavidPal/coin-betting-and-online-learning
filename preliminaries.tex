...
\citet{Kelly56} proposed a coin betting strategy for the case when the
coin flips $\{g_t\}_{t=1}^\infty$  are generated i.i.d. with known probability
of heads. If $p \in (0,1)$ is the probability of heads, Kelly bet is
$$
\beta_t = 2p - 1 \; .
$$
...
$$
where $\Wealth_t(\beta)$ is the wealth of a strategy that uses betting fraction
$\beta$ in every round.
