...
We show how to use a sequence of coin-betting potentials $\{F_t\}_{t=1}^\infty$
...
\Reward_t$, i.e., in accordance with the equation
...
$t=0$ is trivial, since both sides of the inequality are equal $\epsilon$.
...
$F^*(\|\cdot\|)$; see \citet[Example 13.7]{BauschkeC2011}.
\end{proof}
