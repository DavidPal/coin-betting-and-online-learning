\section{Binary and Continuous Coin Betting}
...
% 
% \noindent\textbf{Online Linear Optimization over a Hilbert Space $\H$} is an online
...
% 
% 
% \noindent\textbf{Learning with Expert Advice.} Let $N \ge 2$ be a positive integer. \textsc{Learning with expert advice} is an
...
% \norm{x}_1 = 1 \}$ and receives a loss vector $\ell_t \in [0,1]^N$. Similarly
