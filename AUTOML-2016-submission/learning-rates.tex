...
% The exact same problem is present for \ac{LEA}.
% %Hedge algorithm~\citep{Freund-Schapire-1997}
% %is identical to \ac{OMD} with regularizer $R(u) = -H(u)$.
...
% \end{equation}
% %
% As before, one \emph{would like to have} a single
...
% \]
% %
% Again, algorithms of this type are called \emph{parameter-free}.
%since, in contrast to Hedge, they do not need to know $p$.
