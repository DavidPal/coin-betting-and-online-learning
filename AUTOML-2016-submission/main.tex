...
simple, easy to implement, and parameter-free. The regret of the first algorithm is as good
as the regret of gradient descent with the best possible learning rate. The regret of
