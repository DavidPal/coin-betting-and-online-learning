...
\author{%
\Name{Francesco Orabona}\thanks{Work done while at Yahoo Research.}
\Email{francesco@orabona.com}\\
\addr Stony Brook University, Stony Brook, NY 11794, USA
\AND
\Name{D\'avid P\'al}
...
\begin{abstract}
We present a new parameter-free algorithm for online linear optimization over
any Hilbert space. It is theoretically optimal, with regret guarantees as good
as with the best possible learning rate. The algorithm is simple and easy to
