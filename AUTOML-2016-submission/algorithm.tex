...
Our new parameter-free algorithm for \ac{OLO} over a Hilbert space $\H$ is
stated as Algorithm~\ref{algorithm:hilbert-space-olo}.  The theorem below upper
bounds its regret, the proof can be found
