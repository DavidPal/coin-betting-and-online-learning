...
\footnotetext[2]{The algorithm in \cite{Foster-Rakhlin-Sridharan-2015} does not have a per-round time complexity independent of $T$, but it can be modified to achieve the stated complexity~\cite{Daniely:private}.}