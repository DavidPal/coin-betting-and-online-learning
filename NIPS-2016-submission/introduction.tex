...
algorithms for \ac{OLO} and \ac{LEA} are new, simple, and natural. They also have optimal guarantees on
...
\bottomrule
\end{tabular}}
\caption{Algorithms for \ac{OLO} over Hilbert space and \ac{LEA}. We apologize for the big, but necessary, number of symbols used.
