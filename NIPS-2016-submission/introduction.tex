...
\footnotetext[2]{The proof in \cite{Koolen-van-Erven-2015} can be modified to prove a KL divergence bound, as the author points out in \url{http://blog.wouterkoolen.info/Squint_PAC/post.html}.}
