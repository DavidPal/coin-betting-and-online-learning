...
Luo-Schapire-2015} for \ac{LEA}, approximates \eqref{eq:opt_wealth} and it is an excellent coin betting potential---see Theorem~\ref{thm:exp_x2} in Appendix~\ref{section:optimal-betting-fraction}. Hence, our framework provides intuition to previous constructions.
In Section~\ref{section:kt-estimator} we will show new examples of coin-betting potentials, while in the next two sections, we reduce \ac{OLO} and \ac{LEA} to coin-betting.
