...
Lambert function $W(x):[0,\infty) \to [0,\infty)$ is defined by the equality
\begin{equation}
\label{eq:lambert}
...
\]
Setting $t=T$ and overapproximating $g_t^{-1}(\KL{u}{\pi})$ we get the stated bound that holds for any $\delta>0$.
\end{proof}
