...
\end{equation}
Analogously to \eqref{equation:one-dimensional-olo}, the prediction of the OLO algorithm
...
The proof reduces the general Hilbert case to a 1-d case, thanks to (d) in Definition~\ref{definition:potential}, then it follows the  reasoning in Section~\ref{section:one-dimensional-hilbert-space-olo}.
%
