...
\end{equation}
This definition of $\beta_t$ is a generalization of \eqref{equation:potential-based-strategy}.  Analogously to \eqref{equation:one-dimensional-olo}, the prediction of the OLO algorithm
...
The proof reduces the general Hilbert case to a 1-d case, thanks to property 4 in Definition~\ref{definition:potential}, then it follows the same reasoning outlined in Section~\ref{section:one-dimensional-hilbert-space-olo}.
%
