...
The one-dimensional construction in Section~\ref{section:one-dimensional-hilbert-space-olo} can be generalized to an arbitrary
Hilbert space $\H$. First, define reward and wealth analogously
