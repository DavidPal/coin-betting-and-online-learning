...
We note explicitely that multiplying in round $t$ all the $w_{t,i}$ by a positive number does not change the prediction $p_t$. We will make use of this observation in Section~\ref{section:kt-lea}.
