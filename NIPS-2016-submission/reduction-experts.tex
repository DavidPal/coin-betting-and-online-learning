...
the one-dimensional Hilbert space $\R$, based on the coin-betting potentials
$\{F_t\}_{t=0}^\infty$ for an initial
endowment of $1$. Let $f_t^{-1}$ be the inverse of $f_t(x) = \ln(F_t(x))$
