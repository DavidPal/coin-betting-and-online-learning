...
\citep{ChaudhuriFH09,LuoS14,LuoS15}. It is now clear that that potential is
...
\norm{g_{i}}}\right)$ is an excellent coin betting potential. Through our
reductions, such potential would recover at the same time the bounds in
\citet{LuoS15} and \citet{Orabona14}. It is an open problem to design a coin
betting potential of the form $\exp \left(\frac{x^2}{1+\sum_{i=1}^{t-1}
