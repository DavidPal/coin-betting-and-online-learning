...
if it satisfies the following three conditions for every $t \ge 0$,
\begin{enumerate}
...
$$
\item For every $t \ge 0$, $F_t(0) = \epsilon > 0$.
...
$$
\end{enumerate}
If, in addition, for every $t \ge 0$, $F_t$ is twice-differentiable and
satisfies $x \cdot F_t''(x) \ge F_t'(x)$ for every $x \in I_t$ then
