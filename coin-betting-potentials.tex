...
is called a \textbf{sequence of coin-betting potentials for initial
...
strategy~\eqref{equation:potential-based-strategy} might seem mystical. However,
...
[-1,1]} h(g_t,\beta_t)$. Solution of this minimization problem is
$\beta_t$ given by \eqref{equation:potential-based-strategy}; see
Theorem~\ref{theo:opt_beta} in
